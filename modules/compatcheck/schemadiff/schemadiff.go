...
// This function takes four params:
// 1. base schema with version-a of engine
// 2. base schema with version-b of engin
...
//
// It then calculate the diff between base schema's of version-a and version-b
// and then calculate the diff between full schema (with module installed) of version-a and version-b
// and then compare the two diff, but ignores the diff that was seen in base schema as well.
//
