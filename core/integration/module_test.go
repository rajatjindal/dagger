...
func (ModuleSuite) TestGoInit(ctx context.Context, t *testctx.T) {
	...
	t.Run("single character, kebab case module name", func(ctx context.Context, t *testctx.T) {
		c := connect(ctx, t)
	...
	t.Run("single character, dots in module name", func(ctx context.Context, t *testctx.T) {
		c := connect(ctx, t)
